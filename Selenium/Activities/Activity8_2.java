...
public class Activity8_2 {
    public static void main(String[] args) {
        ...
        System.out.println("Second row, second column value(Before sorting) is : " + cellValueBefore.getText());
        ...
        System.out.println("Second row, second column value(After sorting) is : " + cellValueAfter.getText());

        WebElement footer = driver.findElement(By.xpath("//table[@id='sortableTable']/tfoot/tr"));
        System.out.println("Table footer values are : " + footer.getText());
